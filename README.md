...
- 🎓 CSE student, currently deep in **circuit analysis** and **algorithm design**
- 💻 Independently build and deploy frontend projects under **RITHIK.DEV**
- 🌐 Focused on clean UI, glassmorphism aesthetics, and original design — no templated clones
- ⚡ Comfortable across the stack: from Thevenin equivalents to Shunting-Yard parsers to production-ready web forms
- 🏆 Football fan — I debate tactics as fiercely as I debug code
- 📫 Always open to collaborating on interesting frontend / web projects
...
<img src="https://skillicons.dev/icons?i=html,css,js,ts,react,nodejs,vercel,git,github,figma,vscode,c,cpp,python&perline=7" alt="Tech stack icons" />
...
<!-- ============================================================
     ...
     Requires a GitHub Actions workflow — see snk.yml below.
     The SVG it generates is referenced here.
     ============================================================ -->
## 🐍 Contribution Snake
...
<a href="https://your-portfolio-url.dev" target="_blank">
...
### ⚡ Fun Fact
I debug circuits and code with the same mindset: trace the signal, find where it breaks, fix the loop.
